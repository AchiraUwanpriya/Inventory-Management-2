        ...
        <div style={styles.headerContent}>
          ...
          <div>
            ...
            <p style={styles.pageSubtitle}>
              Manage customers and their contact information across the system
            </p>
          </div>
        </div>
      </div>
                  ...
                  <div>
                    ...
                    <div style={styles.formGroup}>
                      ...
                      <input
                        ...
                        style={{
                          ...styles.input,
                          borderColor: formErrors.CustomerName
                            ? colors.error
                            : colors.grayLighter,
                        }}
                        required
                        onFocus={(e) => {
                          e.target.style.borderColor = formErrors.CustomerName
                            ? colors.error
                            : colors.primary;
                          e.target.style.boxShadow = `inset 0 2px 8px rgba(0,0,0,0.1), 0 0 0 3px ${colors.shadowLight}`;
                        }}
                    ...
                    >
                      {c.Phone && (
                        ...
                        >
                          ...
                          />
                          <span
                            style={{ fontSize: isMobile ? "13px" : "inherit" }}
                          >
                            {c.Phone}
                          </span>
                        </div>
