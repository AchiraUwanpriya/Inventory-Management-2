...
const Products = () => {
  ...
  const activeProducts = localProducts.filter(
    (p) => p.Status === "Active",
  ).length;
  const inactiveProducts = localProducts.filter(
    (p) => p.Status === "Inactive",
  ).length;
  ...
  const handleFileSelect = (e) => {
    ...
    if (file) {
      ...
      if (!validTypes.includes(file.type)) {
        showPopupMessage(
          "⚠️ Please select a valid image file (JPEG, PNG, GIF)",
          true,
        );
        return;
      }
  ...
  const styles = {
    ...
    searchInput: {
      padding: isMobile ? "14px 16px 14px 40px" : "18px 24px 18px 48px",
        ...
        <div style={styles.headerContent}>
          ...
          <div>
            ...
            <p style={styles.pageSubtitle}>
              Manage products, inventory items and their details across the
              system
            </p>
          </div>
        </div>
              ...
              {currentItems.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={styles.tableCell}>{unit?.UnitName || "N/A"}</td>
                    <td
                      style={{
                        ...styles.tableCell,
                        fontWeight: "600",
            ...
            <div style={styles.paginationControls}>
              ...
              {getPageNumbers().map((pageNumber, index) =>
                pageNumber === "..." ? (
                  <span
                    key={`ellipsis-${index}`}
                    style={{ padding: "0 8px", color: colors.gray }}
                  >
                    ...
                  </span>
                ) : (
                  ...
                  <div>
                    ...
                    <div style={styles.formGroup}>
                      ...
                      <div
                        ...
                        onDragLeave={(e) => {
                          e.preventDefault();
                          e.currentTarget.style.borderColor = imagePreview
                            ? colors.primary
                            : colors.grayLighter;
                          e.currentTarget.style.backgroundColor = colors.light;
                        }}
