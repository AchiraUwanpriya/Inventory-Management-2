...
const PurchaseOrders = () => {
  ...
  const loading =
    purchaseOrdersState?.loading || purchaseOrderItemsState?.loading || false;
  ...
  const getNextOrderId = () => {
    ...
    const maxId = Math.max(
      ...purchaseOrders.map((o) => Number(o.PurchaseOrderID) || 0),
    );
    return maxId + 1;
  };
  ...
  const mergedOrders = useMemo(() => {
    const merged = purchaseOrders.map((order) => {
      const items = purchaseOrderItems
        .filter(
          (i) => String(i.PurchaseOrderID) === String(order.PurchaseOrderID),
        )
        .map((i) => {
  ...
  const filteredOrders = useMemo(() => {
    return mergedOrders.filter((order) => {
      const orderId = String(order.PurchaseOrderID || "");
      const supplierName =
        suppliers.find((s) => String(s.SupplierID) === String(order.SupplierID))
          ?.SupplierName || "";
  ...
  const selectedOrderDetails = useMemo(() => {
    ...
    return mergedOrders.find(
      (order) => String(order.PurchaseOrderID) === String(selectedOrderForView),
    );
  }, [selectedOrderForView, mergedOrders]);
  ...
  const handleAddLocalItem = (e) => {
    ...
    if (!newItem.ProductID || !newItem.Quantity || !newItem.UnitPrice) {
      showPopupMessage(
        "⚠️ Please select a product, enter quantity and unit price",
        true,
      );
      return;
    }
  ...
  const styles = {
    ...
    searchIcon: {
      position: "absolute",
      left: isSmallMobile ? "4px" : isMobile ? "8px" : "16px",
      color: colors.primary,
      fontSize: isSmallMobile ? "16px" : isMobile ? "20px" : "24px",
    },
    filterSelect: {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div style={styles.headerContent}>
          <Truck
            size={isSmallMobile ? 32 : isMobile ? 40 : 52}
            color={colors.white}
          />
          <div>
            <h1 style={styles.pageTitle}>PURCHASE ORDERS MANAGEMENT</h1>
            <p style={styles.pageSubtitle}>
              Manage purchase orders and supplier transactions across the system
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={styles.controls}>
        ...
        >
          <Plus size={isSmallMobile ? 16 : isMobile ? 20 : 24} /> CREATE
          PURCHASE ORDER
        </button>
      </div>
            ...
            <tr>
              <th
                style={{
                  ...
                  width: isSmallMobile ? "20%" : isMobile ? "25%" : "20%",
                }}
              >
                Order ID
              </th>
              <th
                style={{
                  ...styles.tableHeaderCell,
                  width: isSmallMobile ? "30%" : isMobile ? "35%" : "30%",
                }}
              >
                Supplier
              </th>
              <th
                style={{
                  ...styles.tableHeaderCell,
                  width: isSmallMobile ? "20%" : isMobile ? "20%" : "20%",
                }}
              >
                Order Date
              </th>
              ...
              <th
                style={{
                  ...styles.tableHeaderCell,
                  width: isSmallMobile ? "10%" : isMobile ? "15%" : "10%",
                  textAlign: "center",
                }}
              >
                Actions
          ...
          <tbody>
            {loading ? (
              ...
              currentItems.map((order) => {
                const supplierName =
                  suppliers.find(
                    (s) => String(s.SupplierID) === String(order.SupplierID),
                ...
                return (
                  ...
                  >
                    ...
                    <td style={styles.tableCell}>
                      ...
                      >
                        <Building2
                          size={isSmallMobile ? 12 : isMobile ? 14 : 18}
                          color={colors.primary}
                        />
                        <span
                          style={{
                        ...
                        >
                          {isSmallMobile && supplierName.length > 15
                            ? `${supplierName.substring(0, 15)}...`
                            : isMobile && supplierName.length > 20
              ...
              <tr>
                ...
                >
                  ...
                  >
                    <Truck
                      size={isSmallMobile ? 36 : isMobile ? 48 : 72}
                      color={colors.grayLight}
                    />
                    <p
                      style={{
              ...
              <form onSubmit={handleAddOrder}>
                ...
                <div style={styles.formGroup}>
                  ...
                  <div style={styles.dropdownContainer}>
                    <input
                      ...
                      style={{
                        ...styles.input,
                        borderColor: !newOrder.SupplierID
                          ? colors.error
                          : colors.grayLighter,
                      }}
                      onBlur={() =>
                ...
                >
                  ...
                  >
                    ...
                    enter the unit price for each product. The price will NOT
                    auto-fill when selecting products.
                  </div>
                </div>
                ...
                {localItems.length > 0 ? (
                    ...
                    <div style={styles.tableContainer}>
                      <table style={styles.itemsTable}>
                        ...
                        <tbody>
                              ...
                              <tr key={it.ProductID} style={styles.tableRow}>
                                <td style={styles.tableCell}>
                                  ...
                                  >
                                    ...
                                    >
                                      {isSmallMobile && productName.length > 15
                                        ? `${productName.substring(0, 15)}...`
                                        : isMobile && productName.length > 20
                                    ...
                                    {isEditing ? (
                                      ...
                                      <>
                                        ...
                                        <button
                                          ...
                                          onClick={() =>
                                            handleRemoveLocalItem(it.ProductID)
                                          }
                                          title="Remove item"
                                        >
                                          <X
                          ...
                          >
                            <td
                              colSpan={isSmallMobile ? 2 : isMobile ? 2 : 3}
                              style={{
                                ...styles.tableCell,
                                textAlign: "right",
                                fontWeight: "700",
                  ...
                  >
                    <Package
                      size={isSmallMobile ? 24 : isMobile ? 36 : 48}
                      style={{
                        marginBottom: isSmallMobile
                          ? "8px"
                          : isMobile
                    ...
                    >
                      Search and add products above to create your purchase
                      order
                    </div>
                  </div>
                )}
                ...
                <div style={styles.buttonGroup}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      ...styles.primaryButton,
                      opacity:
                        localItems.length === 0 || !newOrder.SupplierID
                          ? 0.6
                          : 1,
                    }}
                    onMouseOver={(e) => {
          ...
          <div style={{ ...styles.modalContent, ...styles.wideFormContainer }}>
            <div style={styles.modalHeader}>
              <h3 style={styles.modalTitle}>
                VIEW PURCHASE ORDER #{selectedOrderDetails.PurchaseOrderID}
              </h3>
              <button
                style={styles.closeButton}
                onClick={() => {
                  ...
                  <span style={styles.infoValue}>
                    {
                      suppliers.find(
                        (s) =>
                          String(s.SupplierID) ===
                          String(selectedOrderDetails.SupplierID),
                      )?.SupplierName
                    }
                  </span>
                </div>
                          ...
                          <tr key={idx} style={styles.tableRow}>
                            <td style={styles.tableCell}>
                              ...
                              >
                                ...
                                >
                                  {isSmallMobile && item.productName.length > 15
                                    ? `${item.productName.substring(0, 15)}...`
                                    : isMobile && item.productName.length > 20
